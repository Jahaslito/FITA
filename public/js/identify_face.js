        ...
        $.ajax({
            ...
            success:function(result) {
                if (result=="ERROR_1") {
                    ...
                    setTimeout(function() {
                        if (status=="success") {
                            modifiedDisplayMessage("new-success","Your attendance is successfully taken");
                        }else{
                            modifiedDisplayMessage("new-error","Your attendance is already taken");
                        }
                    }, 3000);
