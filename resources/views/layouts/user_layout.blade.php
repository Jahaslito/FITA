    ...
    <div class="navbar">
        ...
        <div class="navbar-lists">
            ...
            <div id="profile-box" class="right">
                ...
                {{-- <div class="list">   
                    <i class="fas fa-caret-down" id="more-list-down"></i>
                    <i class="fas fa-caret-up" id="more-list-up"></i>
                </div>
                <div class="sub-list" id="more-sub-list">
                    <div class="list" onclick= "createQRCode()">
                        <i class="fas fa-solid fa-qrcode"></i>
                        <p> <a onclick="profile()" style='color:white; text-decoration:none;'>Profile</a></p>
                    </div>
                    <div class="list">
                        <i class="fas fa-solid fa-qrcode"></i>
                        <p> <a onclick="trainFace()" style='color:white; text-decoration:none;'>Train face</a></p>
                    </div>
                    <div class="list">
                        <i class="fas fa-solid fa-qrcode"></i>
                        <p> <a onclick="logout()" style='color:white; text-decoration:none;'>Logout</a></p>
                    </div>
                </div> --}}
